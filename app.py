...
st.title("Churn Retention Copilot")
...
with st.sidebar:
    ...
    numdayscontractequipmentplanexpiring = st.number_input(
    ...
    percentagecalloutsidenetwork = st.number_input(
...
if analyze_button:
    ...
    customer = CustomerFeatures(
        ...
        monthlybilledamount=monthlybilledamount,
        numberofcomplaints=numberofcomplaints,
        numberofmonthunpaid=numberofmonthunpaid,
        numdayscontractequipmentplanexpiring=(
            numdayscontractequipmentplanexpiring
        ),
        penaltytoswitch=penaltytoswitch,
        totalminsusedinlastmonth=totalminsusedinlastmonth,
    ...
    with st.spinner("Analyzing customer..."):
        st.session_state.result = analyze_customer(customer)
...
if "result" in st.session_state:
    ...
    with st.chat_message("assistant"):
        ...
        for reason in recommendation.main_reasons:
        ...
        st.info(recommendation.customer_message)

        with st.expander("Model explanation"):
            st.markdown("**Risk drivers**")

            for factor in risk.risk_drivers:
                st.write(
                    f"{factor.feature}: "
    ...
    if user_question:
        ...
        with st.spinner("Thinking..."):
            followup_answer = answer_followup(
